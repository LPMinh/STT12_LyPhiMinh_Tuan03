...
export default function App() {
  return (
    <View style={styles.container}>
      <View style={[styles.logoContainer]}><Image source={require('./assets/logo.png')} style={[styles.logo]} /></View>
      ...
      <View style={styles.ordermethod}>
         <View style={[styles.line]}></View>Order login method<View style={[styles.line]}></View>
      </View>
      <View style={styles.orderLogin}>
          <TouchableOpacity>
              <Image source={require('./assets/twt.png')} style={[styles.iconMethod]} />
          </TouchableOpacity>
          <TouchableOpacity>
              <Image source={require('./assets/wifi.png')} style={[styles.iconMethod]} />
          </TouchableOpacity>
          <TouchableOpacity>
              <Image source={require('./assets/fb.png')} style={[styles.iconMethod]} />
          </TouchableOpacity>
